...
public class Shrinking : MonoBehaviour
{
   ...
   [SerializeField]  private float effectGreatness;

    //check col
    //check if can shrink
    //set old size
    //new size
    //start shrink with current effectgreatness
    //check if it is a potion
    //if potion is hit change effectgreatness * this object effectgreatness
